  ...
  return (
    <AuthLayout role="owner" backTo="/get-started" backLabel="Back to role selection">
      ...
      <p className="text-sm text-muted mb-8">
        Sign in to find mechanics and manage your requests.
      </p>
      ...
      <p className="text-sm text-center text-muted">
        ...
        <Link to="/owner/sign-up" className="text-primary font-semibold hover:underline no-underline">
          Create Account
        </Link>
      </p>
      ...
      <p className="text-xs text-center text-muted/60 mt-4">
        Are you a mechanic?{" "}
        <Link to="/mechanic/sign-in" className="text-muted hover:text-primary no-underline">
          Sign in as Mechanic
        </Link>
      </p>
    </AuthLayout>
